...
- audience — аудитория автора по своей тематике похожа на покупателей продукта
...
reason — объясни мост в 8-12 слов, без имени автора, без общих фраз типа "может подойти".
