...
- если сам решил, что автор не подходит — не включай его в массив вообще. Не пиши "не подходит" в reason у включённого автора: раз пишешь это в массив ответа, значит уже решил, что он в выдаче, а формулировка "не подходит" в самом же reason — это противоречие, а не обоснование
...
Приоритет типов при сравнении score: direct и content весят больше audience при сопоставимой силе аргумента. Прямой эксперт — первый кандидат бизнеса, охват через аудиторию — запасной вариант, а не равноценная альтернатива.

Score:
- 85-100 — сильный direct/content/scenario с явным фактом-мостом
- 65-84 — нормальный direct/content/scenario, ИЛИ audience с очень явным демографическим фактом
- 40-64 — слабое, но объяснимое соответствие (типичный audience-матч, либо слабый direct)
- ниже 40 — не включать

Audience может обойти direct по score только в одном случае: если у автора нет вообще никакой прямой ниши, связанной с продуктом, а демографический признак аудитории исключительно точный.
